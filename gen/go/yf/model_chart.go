...
func (o *Chart) GetResult() []ChartResult {
...
func (o *Chart) GetResultOk() (*[]ChartResult, bool) {
	if o == nil || o.Result == nil {
		return nil, false
	}
...
// SetResult gets a reference to the given []ChartResult and assigns it to the Result field.
func (o *Chart) SetResult(v []ChartResult) {
	o.Result = &v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *Chart) GetError() string {
...
// and a boolean to check if the value has been set.
func (o *Chart) GetErrorOk() (*string, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *Chart) SetError(v string) {
	o.Error = &v
}
